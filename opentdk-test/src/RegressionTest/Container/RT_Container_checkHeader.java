...
public class RT_Container_checkHeader extends BaseRegression {
	...
	protected void runTest() {
		...
		dc1.getTabContainer().setHeaders(new String[] { "header1", "header2", "header3" });
		...
		BaseRegression.testResult(dc1.getTabContainer().checkHeader(compareHeaders1), "Header Compare", 0);

		DataContainer dc2 = new DataContainer();
		dc2.getTabContainer().setHeaders(new String[] { "header1", "header3", "header2" });
		String[] compareHeaders2 = new String[] { "header1", "header2", "header3" };
		BaseRegression.testResult(String.valueOf(dc2.getTabContainer().checkHeader(compareHeaders2)), "Header Compare", "1");
		...
		BaseRegression.testResult(String.valueOf(dc3.getTabContainer().checkHeader(referenceHeaders3, compareHeaders3)), "Header Compare", "0");

		DataContainer dc4 = new DataContainer();
		dc4.getTabContainer().setHeaders(new String[] { "header1", "header3", "header2" });
		String[] compareHeaders4 = new String[] { "header1", "header2", "header4" };
		BaseRegression.testResult(String.valueOf(dc4.getTabContainer().checkHeader(dc4.getTabContainer().getHeaders(), compareHeaders4)), "Header Compare", "-1");
	}
}
