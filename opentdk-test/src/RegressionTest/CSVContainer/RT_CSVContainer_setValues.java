...
public class RT_CSVContainer_setValues extends BaseRegression {
	...
	public void runTest() {
		...
		sb.append("Neotys;Meisinger;86450;M¸nchen;Schneckenburgerstraﬂe;32;null;fme@lk-test.de").append("\n");
		sb.append("LK Test Solutions AG;Winkler;81675;M¸nchen;Schneckenburgerstraﬂe;32;null;lwi@lk-test.de").append("\n");
		...
		testResult(dc.getValue("Straﬂe", 1), "setValue(header,index,value,filter) - value", "Teststrasse");
