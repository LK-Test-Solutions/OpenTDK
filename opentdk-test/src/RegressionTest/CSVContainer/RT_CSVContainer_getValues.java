...
public class RT_CSVContainer_getValues extends BaseRegression {
	...
	public void test1(DataContainer dc) {
		...
		testResult(dc.tabInstance().getValue("Telefon"), "getValue() - Telefon in row 1", expResults1.get(0));
	}

	public void test2(DataContainer dc) {
		List<String> expResults1 = new ArrayList<String>();
		expResults1.add("Musterhausen");
		testResult(dc.tabInstance().getValue("Ort", 1), "getValue(header,rowindex) - Second occurance in column 'Ort'", expResults1.get(0));
	}

	public void test3(DataContainer dc) {
		List<String> expResults1 = new ArrayList<>();
		expResults1.add("Muenchen");
		testResult(dc.tabInstance().getValue(3, 2), "getValue(headerindex,rowindex) - Column 4, Row 3", expResults1.get(0));
	}
	...
	public void test4(DataContainer dc) {
		...
		testResult(dc.tabInstance().getValue("Telefon", fltr), "getValue(header,filter) - Second occurrence in column 'Telefon'", expResults1.get(0));
		...
		testResult(dc.tabInstance().getValue("PLZ", fltr2), "getValue(header,filter) - Third occurance in column 'PLZ'", expResults2.get(0));
	}
	...
	public void test5(DataContainer dc) {
		...
		List<String> outList = dc.tabInstance().getValuesAsList("Nachname");
	...
	public void test6(DataContainer dc) {
		...
		List<String> outList = dc.tabInstance().getValuesAsList("Email", fltr);
		String[] outRow = outList.toArray(new String[outList.size()]);
	...
	public void test7(DataContainer dc) {
		...
		List<String> outList = dc.tabInstance().getValuesAsList("Email", new int[] { 0, 3 }, fltr);
		String[] outRow = outList.toArray(new String[outList.size()]);
	...
	public void test8(DataContainer dc) {	
		String allValues = dc.tabInstance().getValuesAsString();
		StringBuilder sb = new StringBuilder();
		sb.append("LK Test Solutions GmbH;Walter;81675;Muenchen;Schneckenburgerstrasse;32;089/45709053;hwa@lk-test.com").append("\n");
		sb.append("Muster AG;Mustermann;12345;Musterhausen;Musterstrasse;1;0123/4567890;max@muster.mu").append("\n");
		sb.append("LK Test Solutions GmbH;Meisinger;86450;Muenchen;Schneckenburgerstrasse;32;null;fme@lk-test.de").append("\n");
		sb.append("LK Test Solutions GmbH;Winkler;81675;Muenchen;Schneckenburgerstrasse;32;null;lwi@lk-test.de").append("\n");
	...
	public void test10(DataContainer dc) {
		...
		List<String> outList = dc.tabInstance().getValuesAsList("Nachname", fltr);
