...
public class E_XMLFile_Dispatcher_values extends EBaseSettings {
	...
	public static final BaseDispatchComponent THEMES = new BaseDispatchComponent(EBaseSettings.class.getSimpleName(), "Themes", "/AppSettings", "");
	public static final BaseDispatchComponent THEME = new BaseDispatchComponent(EBaseSettings.class.getSimpleName(), "theme", "/AppSettings/Themes", "");
	public static final BaseDispatchComponent BACKGROUND_IMAGE = new BaseDispatchComponent(EBaseSettings.class.getSimpleName(), "bg_image", "/AppSettings/Themes/theme[@name='{param_1}']", "");
}