...
public class RT_Settings_values_Dispatcher extends BaseDispatcher {
	...
	public static final BaseDispatchComponent VALUE = new BaseDispatchComponent(RT_Settings_values_Dispatcher.class.getSimpleName(), "Value", "/Environment/Variable", "");
