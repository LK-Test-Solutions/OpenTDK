...
public class EJsonValues extends BaseDispatcher {
	...
	public static final BaseDispatchComponent NAME = new BaseDispatchComponent(EJsonValues.class, "name", "", "");
	...
	public static final BaseDispatchComponent BOSS_NAME = new BaseDispatchComponent(EJsonValues.class, "name", "people/0", "");
