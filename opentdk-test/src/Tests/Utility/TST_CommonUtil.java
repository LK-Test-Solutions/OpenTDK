...
public class TST_CommonUtil extends BaseRegression {
	...
	protected void runTest() {
		String command = "cmd /c cd testdata\\RegressionTestData && \"C:\\Program Files\\7-Zip\\7z.exe\" a \"..\\RegressionTestData.7z\" *.json *.yaml *.properties *.xml *.csv -t7z -m0=BCJ2 -m1=LZMA:d25:fb255 -m2=LZMA:d19 -m3=LZMA:d19 -mb0:1 -mb0s1:2 -mb0s2:3 -mx";
		...
		command = "cmd /c cd testdata && \"C:\\Program Files\\7-Zip\\7z.exe\" e \"RegressionTestData.7z\" *.json *.yaml *.properties *.xml *.csv -o\"RegressionTestData_Extracted\" -t7z -y -x!*.cmd -x!config.txt -x!*.html";
