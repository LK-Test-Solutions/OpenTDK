...
public abstract class MultiAxisChart<X, Y> extends Chart {
	...
	protected final List<MultiAxisChart.Series<X, Y>> displayedSeries = new ArrayList<>();
...
//	private final com.lk.javafx.chart.Axis<X> customXAxis;
//
//	/** Get the X axis, by default it is along the bottom of the plot */
//	public com.lk.javafx.chart.Axis<X> getCustomXAxis() {
//		return customXAxis;
//	}
	...
	protected ObjectProperty<ObservableList<MultiAxisChart.Series<X, Y>>> data = new ObjectPropertyBase<ObservableList<MultiAxisChart.Series<X, Y>>>() {
...
//		final com.lk.javafx.chart.Axis<X> customXa = getCustomXAxis();
...
//		}
	...
	protected void layoutChartChildren(double top, double left, double width, double height) {
		...
		final Axis<X> xa = getXAxis();
//		final com.lk.javafx.chart.Axis<X> customXa = getCustomXAxis();
		ObservableList<Axis.TickMark<X>> xaTickMarks = null;
//		ObservableList<javafx.scene.chart.Axis.TickMark<X>> customXaTickMarks = null;
//		if (customXa != null) {
...
//					javafx.scene.chart.Axis.TickMark<X> tick = customXaTickMarks.get(i);
