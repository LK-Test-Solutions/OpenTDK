 ...
 * {@link XMLDataContainer} or {@link CSVDataContainer}. The abstract methods defined within
 * <code>CustomContainer</code> need to be implemented in all classes that implement the
 * <code>CustomContainer</code> interface. The abstract default methods do not need to be
 * implemented within these classes, but they can.
 * 
...
interface CustomContainer {
	...
	/**
	 * The {@link #addField(String, String, Filter)} method can be implemented within the specific
	 * <code>DataContainer</code> to add a field and value into the data source. Primarily the method is
	 * designed for data formats, where single nodes or similar elements can be addressed, instead of
	 * columns or rows with multiple values. e.g. the implemented method
	 ...
	 * @param fltr       Filter condition for more precise localization of the element within the data
	 *                   structure.
	 */
	...
	/**
	 * The {@link #addField(String, String, String, Filter)} method can be implemented within the
	 * specific <code>DataContainer</code> to add an attribute name and value to a field within the data
	 * source. Primarily the method is designed for data formats, where single nodes or similar elements
	 * can be addressed, instead of columns or rows with multiple values. e.g. the implemented method
	 * {@link XMLDataContainer#addField(String, String, String, Filter)} adds an attribute name and
	 * value to a tag within the XML document.
	 * 
	 ...
	 * @param fltr           Filter condition for more precise localization of the element within the
	 *                       data structure.
	 */
	...
	/**
	 * The {@link #addField(String, String, String, String, Filter)} method can be implemented within
	 * the specific <code>DataContainer</code> to add an attribute name and value to a field within the
	 * data source. Primarily the method is designed for data formats, where single nodes or similar
	 * elements can be addressed, instead of columns or rows with multiple values. e.g. the implemented
	 * method {@link XMLDataContainer#addField(String, String, String, String, Filter)} adds an
	 * attribute name and value to a tag within the XML document.
	 * 
	 * @param headerName     Name of the element where to add an attribute within the data source.
	 * @param attributeName  Name of the attribute that will be assigned to the element.
	...
	/**
	 * The {@link #deleteField(String, String, String, Filter)} method can be implemented within the
	 * specific <code>DataContainer</code> to delete an attribute name and value from a field within the
	 * data source. Primarily the method is designed for data formats, where single nodes or similar
	 * elements can be addressed, instead of columns or rows with multiple values. e.g. the implemented
	 * method {@link XMLDataContainer#deleteField(String, String, String, Filter)} deletes an attribute
	 * name and value from a tag within the XML document.
	 * 
	 * @param headerName     Name of the element where to delete an attribute from within the data
	 *                       source.
	...
	/**
	 * The {@link #getAttributes(String, String)} method can be implemented within the specific
	 * <code>DataContainer</code> in case that the fields of the data source have additional attributes
	 * attached. e.g.: The {@link XMLDataContainer#getAttributes(String, String)} searches for all tags
	 * with specific attributes like
	 * <code>&lt;CountryCode name="Germany"&gt;+49&lt;/CountryCode&gt;</code>
	 * 
	 * @param expr     Element to search for {@literal ->} the individual purpose of this parameter will
	 *                 be specified within the implementing classes
	 * @param attrName Name of the attribute to search for {@literal ->} the individual purpose of this
	 *                 parameter will be specified within the implementing classes
	 ...
	 *                   values that match the conditions will be retrieved.
	...
	/**
	 * The {@link #setFieldValues(String, int[], String, Filter)} method can be implemented within the
	 * specific <code>DataContainer</code> to assign a value to one or multiple elements that match a
	 * filter condition. This can be convenient for tree and tabular formats.
	 * 
	 * @param headerName Name of the element where to add an attribute within the data source.
